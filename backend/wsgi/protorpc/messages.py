...
class _DefinitionClass(type):
  ...
  def definition_name(cls):
    ...
    if outer_definition_name is None:
      ...
      return '%s.%s' % (outer_definition_name, cls.__name__)
...
class _EnumClass(_DefinitionClass):
  ...
  def numbers(cls):
    ...
    """
    return iter(cls.__by_number.keys())
...
class Enum(object, metaclass=_EnumClass):
...
class _MessageClass(_DefinitionClass):
  ...
  def __new__(cls, name, bases, dct):
    ...
    if bases != (object,):
      ...
      for key, field in list(dct.items()):
...
class Message(object, metaclass=_MessageClass):
...
class MessageField(Field):
  ...
  def __init__(self,
    ...
    """
    valid_type = (isinstance(message_type, str) or
...
class EnumField(Field):
  ...
  def __init__(self, enum_type, number, **kwargs):
    ...
    """
    valid_type = (isinstance(enum_type, str) or
  ...
  def default(self):
    ...
    try:
      ...
      if isinstance(resolved_default, (str, int)):
